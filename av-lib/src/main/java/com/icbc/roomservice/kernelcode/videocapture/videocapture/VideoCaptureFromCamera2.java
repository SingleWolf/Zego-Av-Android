package com.icbc.roomservice.kernelcode.videocapture.videocapture;
...
import com.icbc.roomservice.kernelcode.videocapture.ve_gl.EglBase;
import com.icbc.roomservice.kernelcode.videocapture.ve_gl.EglBase14;
import com.icbc.roomservice.kernelcode.videocapture.ve_gl.GlRectDrawer;
import com.icbc.roomservice.kernelcode.videocapture.ve_gl.GlUtil;
...
public class VideoCaptureFromCamera2 extends ZegoVideoCaptureDevice implements
    ...
    private static final String TAG = VideoCaptureFromCamera2.class.getSimpleName();
    ...
    private int createCamOnCameraThread() {
        ...
        if (mCam == null) {
            ...
            if (mCam == null) {
                Log.d(TAG, "open camera failed, please check system camera status!");
